...
const dummyData = [
  {
    ...
    city: "Titohaven",
    country: "Cambodia",
    createdAt: 1607801809040,
    formattedDate: format(new Date(1607801809040), "yyyy/MM/dd")
  },
  {
  ...
  },
  {
    ...
    formattedDate: format(new Date(1607802018987), "yyyy/MM/dd")
  },
  {
    ...
    formattedDate: format(new Date(1607793024467), "yyyy/MM/dd")
  },
  {
